...
[:Normally Distributed Residuals](#normallydistributedresiduals)</p>
<p>

[:Linear Assocations](#linearassociations)</p>
<p>

[:Non-Independnce](#non-independnce)</p>
<p>

[:Fixed vs Random Effects](#fixedvsrandomeffects)</p>
<p>
...
<!-- #### To embed a section,
test test test... [:LIKE THIS](#modelassumptions)
[:This example](#ToEmbedASection) -->
...
#### :x Normally distributed residuals
xxxxxxx

#### :x Linear Assocations
...
#### **Linear Mixed Model with Random Intercept:** {#sec-equation}
...
`r fontawesome::fa('lightbulb',height='30px',fill='steelblue')` Hypothetical Scenario:
...
<div class="bd-callout bd-callout-info">
<h4 id="dealing-with-specificity", style="color:light"> Dealing with specificity</h4>

<p>This is filler text <code class="highlighter-rouge">&lt;insert code&gt;</code> with the class.</p>
</div>

<!-- ::: {.content-hidden when-format="html"}
### Load/View/Wrangle data section? tidyverse?
